...
class LettersControllerTest < ActionController::TestCase
  ...
  test "should create letter" do
    assert_difference('Letter.count') do
      post :create, letter: { announcements: @letter.announcements, date: @letter.date, liturgy: @letter.liturgy, time1: @letter.time1, time2: @letter.time2, welcome: @letter.welcome }
    end
  ...
  test "should update letter" do
    patch :update, id: @letter, letter: { announcements: @letter.announcements, date: @letter.date, liturgy: @letter.liturgy, time1: @letter.time1, time2: @letter.time2, welcome: @letter.welcome }
    assert_redirected_to letter_path(assigns(:letter))
  end
